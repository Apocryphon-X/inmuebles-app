...
('María López', 'maria.lopez@example.com', '5551234568', '$2b$10$2hDSpugmJuSI6dMVt3W.9e2JURgSIxAPt4r8pCQLPRU7pDmkCNpYO', 'ARRENDATARIO'),
('Carlos García', 'carlos.garcia@example.com', '555123456789', '$2b$10$7YExsPZP90Wauv7UweG.JeSTDga85o7dYN1jQDhLbMUPMcL8EiMR2', 'ALUMNO'),
('Pedro Martínez', 'pedro.martinez@example.com', '5555678901', '$2b$10$rhMJYGq9dkNM6GjL5LukAOcgKvKMR1o..qUPlZEkaH5PZmPHlPSre', 'ARRENDATARIO'),
('Ana Sánchez', 'ana.sanchez@example.com', '5554567890', '$2b$10$bXbQMEr.UeRfG5KchLxU4uWL/w0rz.JW1uC.AuFnc0jYzOInGE9V2', 'ALUMNO'),
('Juan Pérez', 'juan.perez@example.com', '5551234567', '$2b$10$Fg2V/AnwaYnJzu8GK3a7XuPzGYTToQu7wX/o3O3XZlCYZ9SckaFVa', 'ARRENDATARIO');
...
(2, 'Casa en Iztapalapa', 9000, 'Casa', 'Iztapalapa', 'Casa de 3 recamaras, 2 baños, con patio trasero y estacionamiento.', '2024-11-16'),
...
(2, 'Casa en Condesa', 14000, 'Casa', 'Condesa', 'Casa moderna de 4 recamaras, jardin y seguridad privada.', '2024-11-14'),
(5, 'Recamara en Roma Norte', 4000, 'Recamara', 'Roma Norte', 'Recamara acogedora cerca de transporte publico y restaurantes.', '2024-11-12');
